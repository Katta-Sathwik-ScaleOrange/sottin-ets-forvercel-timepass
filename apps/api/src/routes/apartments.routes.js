...
const { search, detect, getPolygon, allPolygons, suggest } = require('../controllers/apartments.controller');
...
router.get('/all-polygons',  allPolygons);        // Public — ALL apartment/office polygons for map
